...
static constexpr const char kDebugMetadataUrl[] = "debugMetadataUrl";
...
static constexpr const char kEnableNewSticky[] = "enableNewSticky";
...
static constexpr const char kEnableParseIntFlex[] = "enableParseIntFlex";
static constexpr const char kEnableGridPlacementShorthands[] =
    "enableGridPlacementShorthands";
static constexpr const char kEnableFlexBasisZeroPercent[] =
    "enableFlexBasisZeroPercent";
static constexpr const char kIncludeFontPadding[] = "includeFontPadding";
static constexpr const char kEnableCSSRule[] = "enableCSSRule";
...
static constexpr const char kEnableEventTargetInfoNodeIndex[] =
    "enableEventTargetInfoNodeIndex";
static constexpr const char kEnableFrontendCustomEventBubbleCompatible[] =
...
static constexpr const char kAlignMouseEventWithW3C[] =
    "alignMouseEventWithW3C";
static constexpr const char kEnableDisexposureWhenBackground[] =
    "enableDisexposureWhenBackground";
static constexpr const char kEnableAnimationForwardUpdatePreservation[] =
    "enableAnimationForwardUpdatePreservation";
static constexpr const char kEnableNewStylingPipeline[] =
    "enableNewStylingPipeline";
static constexpr const char kEnableDispatchCustomEventForUI[] =
    "enableDispatchCustomEventForUI";
static constexpr const char kEnableNativeInteraction[] =
    "enableNativeInteraction";
static constexpr const char kEnableFrameNativeData[] = "enableFrameNativeData";
static constexpr const char kSyncXElementRegistry[] = "syncXElementRegistry";
static constexpr const char kEnableElementApiNewRegistration[] =
