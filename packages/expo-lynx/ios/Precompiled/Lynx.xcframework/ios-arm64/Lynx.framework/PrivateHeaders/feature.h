...
namespace tasm {
namespace report {
static constexpr const uint32_t kAllFeaturesCount = 91;
...
enum LynxFeature : uint32_t {
  ...
  CPP_ENABLE_NATIVE_LIST_FROM_ENV = 45,
  CPP_ELEMENT_FROM_BINARY = 46,
  TYPESCRIPT_BUNDLE_SUPPORT_LOAD_SCRIPT = 47,
  OBJC_IMPLICIT_ANIMATION = 48,
  OBJC_PAGE_RTL = 49,
  OBJC_PAGE_RTL_WITH_LIST = 50,
  OBJC_DISABLE_NEW_TRANSFORM_ORIGIN_IOS = 51,
  OBJC_AUTO_RESUME_ANIMATION = 52,
  OBJC_LAYOUT_ANIMATION_CREATE = 53,
  OBJC_LAYOUT_ANIMATION_UPDATE = 54,
  OBJC_LAYOUT_ANIMATION_DELETE = 55,
  OBJC_ENTER_TRANSITION_NAME = 56,
  OBJC_EXIT_TRANSITION_NAME = 57,
  OBJC_PAUSE_TRANSITION_NAME = 58,
  OBJC_RESUME_TRANSITION_NAME = 59,
  OBJC_UPDATE_FONT_SCALE = 60,
  OBJC_DISABLE_REUSE_ANIMATION_STATE = 61,
  OBJC_LIST_IOS_RECURSIVE_LAYOUT = 62,
  OBJC_LIST_IOS_DISABLE_SCROLL_ANIM_DURING_LAYOUT = 63,
  OBJC_LIST_IOS_USE_SCROLLER = 64,
  OBJC_LIST_PAGING_ENABLE = 65,
  OBJC_DISABLE_TOUCH_REFACTOR = 66,
  OBJC_SET_THEME_IOS = 67,
  OBJC_GET_THEME_IOS = 68,
  OBJC_UI_OWNER_RELEASE_ON_CHILD_THREAD = 69,
  OBJC_ENABLE_ASYNC_LIST = 70,
  OBJC_USE_LEGACY_ELEMENTS = 71,
  JAVA_HARDWARE_LAYER = 72,
  JAVA_NEW_SWIPER_NOT_ENABLED = 73,
  JAVA_LAYOUT_ANIMATION_CREATE_ANDROID = 74,
  JAVA_LAYOUT_ANIMATION_UPDATE_ANDROID = 75,
  JAVA_LAYOUT_ANIMATION_DELETE_ANDROID = 76,
  JAVA_ENTER_TRANSITION_NAME_ANDROID = 77,
  JAVA_EXIT_TRANSITION_NAME_ANDROID = 78,
  JAVA_PAUSE_TRANSITION_NAME_ANDROID = 79,
  JAVA_RESUME_TRANSITION_NAME_ANDROID = 80,
  JAVA_UPDATE_FONT_SCALE = 81,
  JAVA_DISABLE_REUSE_ANIMATION_STATE = 82,
  JAVA_DISABLE_FOLDVIEW_STOP_TOUCH_STOP_FLING = 83,
  JAVA_ASYNC_REDIRECT = 84,
  JAVA_ENABLE_ASYNC_REQUEST_IMAGE = 85,
  JAVA_SET_THEME_ANDROID = 86,
  JAVA_GET_THEME_ANDROID = 87,
  JAVA_ENABLE_ASYNC_LIST = 88,
  JAVA_USE_LEGACY_ELEMENTS = 89,
  JAVA_ENABLE_FONT_SCALING = 90,
};
...
inline const char* LynxFeatureToString(LynxFeature feature) {
  switch (feature) {
    ...
    case CPP_ENABLE_NATIVE_LIST_FROM_ENV: {
      return "cpp_enable_native_list_from_env";
    }
    case CPP_ELEMENT_FROM_BINARY: {
      return "cpp_element_from_binary";
    }
