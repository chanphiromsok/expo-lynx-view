...
class LynxConfig : public EntryConfig {
 public:
  ...
  inline void SetDebugMetadataUrl(const std::string& debug_metadata_url) {
    debug_metadata_url_ = debug_metadata_url;
  }
  inline std::string GetDebugMetadataUrl() const { return debug_metadata_url_; }
  ...
  inline void SetEnableNewSticky(bool enable_new_sticky) {
    enable_new_sticky_ = enable_new_sticky;
  }
  inline bool GetEnableNewSticky() const { return enable_new_sticky_; }
  ...
  inline void SetEnableParseIntFlex(bool enable_parse_int_flex) {
    enable_parse_int_flex_ = enable_parse_int_flex;
  }
  inline bool GetEnableParseIntFlex() const { return enable_parse_int_flex_; }

  inline void SetEnableGridPlacementShorthands(
      bool enable_grid_placement_shorthands) {
    enable_grid_placement_shorthands_ = enable_grid_placement_shorthands;
  }
  inline bool GetEnableGridPlacementShorthands() const {
    return enable_grid_placement_shorthands_;
  }

  inline void SetEnableFlexBasisZeroPercent(
      bool enable_flex_basis_zero_percent) {
    enable_flex_basis_zero_percent_ = enable_flex_basis_zero_percent;
  }
  inline bool GetEnableFlexBasisZeroPercent() const {
    return enable_flex_basis_zero_percent_;
  }

  inline void SetEnableCSSRule(bool enable_css_rule) {
    enable_css_rule_ = enable_css_rule;
  }
  inline bool GetEnableCSSRule() const { return enable_css_rule_; }
  ...
  inline void SetEnableEventTargetInfoNodeIndex(
      bool enable_event_target_info_node_index) {
    enable_event_target_info_node_index_ = enable_event_target_info_node_index;
  }
  inline bool GetEnableEventTargetInfoNodeIndex() const {
    return enable_event_target_info_node_index_;
  }

  inline void SetEnableFrontendCustomEventBubbleCompatible(
      bool enable_frontend_custom_event_bubble_compatible) {
    enable_frontend_custom_event_bubble_compatible_ =
        enable_frontend_custom_event_bubble_compatible;
  }
  inline bool GetEnableFrontendCustomEventBubbleCompatible() const {
  ...
  inline void SetAlignMouseEventWithW3C(bool align_mouse_event_with_w3c) {
    align_mouse_event_with_w3c_ = align_mouse_event_with_w3c;
  }
  inline bool GetAlignMouseEventWithW3C() const {
    return align_mouse_event_with_w3c_;
  }

  inline void SetEnableDisexposureWhenBackground(
      bool enable_disexposure_when_background) {
    enable_disexposure_when_background_ = enable_disexposure_when_background;
  }
  inline bool GetEnableDisexposureWhenBackground() const {
    return enable_disexposure_when_background_;
  }

  inline void SetEnableAnimationForwardUpdatePreservation(
      bool enable_animation_forward_update_preservation) {
    enable_animation_forward_update_preservation_ =
        enable_animation_forward_update_preservation;
  }
  inline bool GetEnableAnimationForwardUpdatePreservation() const {
    return enable_animation_forward_update_preservation_;
  }

  inline void SetEnableNewStylingPipeline(bool enable_new_styling_pipeline) {
    enable_new_styling_pipeline_ = enable_new_styling_pipeline;
  }
  inline bool GetEnableNewStylingPipeline() const {
    return enable_new_styling_pipeline_;
  }

  inline void SetEnableDispatchCustomEventForUI(
      bool enable_dispatch_custom_event_for_ui) {
    enable_dispatch_custom_event_for_ui_ = enable_dispatch_custom_event_for_ui;
  }
  inline bool GetEnableDispatchCustomEventForUI() const {
    return enable_dispatch_custom_event_for_ui_;
  }

  inline void SetEnableNativeInteraction(bool enable_native_interaction) {
    enable_native_interaction_ = enable_native_interaction;
  }
  inline bool GetEnableNativeInteraction() const {
    return enable_native_interaction_;
  }

  inline void SetEnableFrameNativeData(bool enable_frame_native_data) {
    enable_frame_native_data_ = enable_frame_native_data;
  }
  inline bool GetEnableFrameNativeData() const {
    return enable_frame_native_data_;
  }

  inline void SetSyncXElementRegistry(bool sync_x_element_registry) {
    sync_x_element_registry_ = sync_x_element_registry;
  }
  inline bool GetSyncXElementRegistry() const {
    return sync_x_element_registry_;
  }

  inline void SetEnableElementApiNewRegistration(
      bool enable_element_api_new_registration) {
    enable_element_api_new_registration_ = enable_element_api_new_registration;
  }
  inline bool GetEnableElementApiNewRegistration() const {
    return enable_element_api_new_registration_;
  }
 ...
 protected:
  ...
  std::string debug_metadata_url_{""};
  ...
  bool enable_new_intersection_observer_{true};
  ...
  bool enable_event_target_info_node_index_{false};
  bool enable_frontend_custom_event_bubble_compatible_{true};
  ...
  bool enable_disexposure_when_background_{true};
  bool enable_animation_forward_update_preservation_{false};
  bool enable_new_styling_pipeline_{false};
  bool enable_dispatch_custom_event_for_ui_{false};
  bool enable_native_interaction_{false};
  bool enable_frame_native_data_{false};
  bool sync_x_element_registry_{false};
  bool enable_element_api_new_registration_{false};
  /**
