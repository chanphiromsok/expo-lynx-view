...
HANDLER_REGISTER_IMPL_INL() {
  ...
  array[kPropertyIDXCaretWidth] = &Handle;
  array[kPropertyIDXCaretHeight] = &Handle;
  array[kPropertyIDXCaretRadius] = &Handle;
  array[kPropertyIDTextDecorationThickness] = &Handle;
  array[kPropertyIDXTextDecorationWidth] = &Handle;
  array[kPropertyIDXTextDecorationGap] = &Handle;
