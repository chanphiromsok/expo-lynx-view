...
#define FOREACH_ALL_PROPERTY(V)                                               \
  ...
  V(XAutoFontSizeLineRanges, "-x-auto-font-size-line-ranges", "")             \
  V(GridColumn, "grid-column", "auto")                                        \
  V(GridRow, "grid-row", "auto")                                              \
  V(MaskComposite, "mask-composite", "add")                                   \
  V(XCaretGradient, "-x-caret-gradient", "none")                              \
  V(XCaretWidth, "-x-caret-width", "0px")                                     \
  V(XCaretHeight, "-x-caret-height", "0px")                                   \
  V(XCaretRadius, "-x-caret-radius", "0px")                                   \
  V(TextDecorationThickness, "text-decoration-thickness", "0px")              \
  V(XTextDecorationWidth, "-x-text-decoration-width", "0px")                  \
  V(XTextDecorationGap, "-x-text-decoration-gap", "0px")
