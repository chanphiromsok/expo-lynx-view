...
// The script may execute timeout.
FOUNDATION_EXPORT NSInteger const ECLynxBTSRuntimeErrorExecuteTimeoutError;
...
// Behavior: JsCallNativeFunction
// Description: Error occurred while calling native C++ method from JS.
// BehaviorCode: 204

// Calling native C++ method too frequently. This may cause OOM issues.
FOUNDATION_EXPORT NSInteger const ECLynxBTSJsCallNativeFunctionTooFrequency;
...
FOUNDATION_EXPORT NSInteger const ECLynxResourceModuleAwaitTimeout;
